...
# WLAN statuses
WLAN_STATUS_ACTIVE = 1
WLAN_STATUS_PLANNED = 2
WLAN_STATUS_RESERVED = 3
WLAN_STATUS_DEPRECATED = 4
WLAN_STATUS_CHOICES = (
    (WLAN_STATUS_ACTIVE, 'Active'),
    (WLAN_STATUS_PLANNED, 'Planned'),
    (WLAN_STATUS_RESERVED, 'Reserved'),
    (WLAN_STATUS_DEPRECATED, 'Deprecated')
)
